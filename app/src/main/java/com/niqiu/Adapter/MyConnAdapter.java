 ...
 */
public class MyConnAdapter extends BaseAdapter {

    LayoutInflater inflater;
    List<ScanResult> list;
    Context context;

    public MyConnAdapter(Context context, List<ScanResult> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ip.setText(String.valueOf(Math.abs(scanResult.level)));
